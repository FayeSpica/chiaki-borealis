...
# wget https://download.firedaemon.com/FireDaemon-OpenSSL/openssl-1.1.1s.zip &&
# 7z x openssl-1.1.*.zip

# wget https://www.libsdl.org/release/SDL2-devel-2.26.2-VC.zip &&
# 7z x SDL2-devel-2.26.2-VC.zip
